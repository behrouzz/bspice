...
t = '2022-12-11 14:20:00'


EARTH = earth_icrs(t, kernels, abccorr='NONE')

icrs_car = [sph2car(i) for i in ra_dec_r]
gcrs_car = [(i-EARTH) for i in icrs_car]
gcrs_sph = [car2sph(i) for i in gcrs_car]

ecl_sph = [equ_sph2ecl_sph(i) for i in gcrs_sph]
...
print(sph2car(equ_sph2ecl_sph(ra_dec_r[0])))
print(np.matmul(arr, icrs_car[0]))
"""
